/*
 * Create by BobEve on 17-12-9 下午10:04
 * Copyright (c) 2017. All rights reserved.
 *
 * Last modified 17-12-9 下午10:04
 */
...
public class StringUtils {
	...
	public static String getJson(Context context, String fileName) {
		...
		try {
			...
			isr = new InputStreamReader(assetManager.open(fileName), "UTF-8");
			//使用IO流读取json文件内容
	...
	public static String capitalizeFirstLetter(String str) {
		...
		return (!Character.isLetter(c) || Character.isUpperCase(c)) ? str : new StringBuilder(
				str.length()).append(Character.toUpperCase(c))

/*
 * Create by BobEve on 17-12-18 下午6:59
 * Copyright (c) 2017. All rights reserved.
 *
 * Last modified 17-12-18 下午6:59
 */
...
public class ParallaxViewPager extends ViewPager {
	...
	private Drawable mRightShadow = new GradientDrawable(LEFT_RIGHT, new int[] {
			mShadowStart, mShadowMid, mShadowEnd
	});
	private Drawable mLeftShadow = new GradientDrawable(RIGHT_LEFT, new int[] {
			mShadowStart, mShadowMid, mShadowEnd
	});
	...
	public ParallaxViewPager(Context context, AttributeSet attrs) {
		...
		mShadowWidth = a.getDimensionPixelSize(R.styleable.ParallaxViewPager_shadow_width,
																					 (int) dp2px(20, getContext()));

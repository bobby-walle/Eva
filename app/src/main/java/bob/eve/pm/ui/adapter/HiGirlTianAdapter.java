/*
 * Create by BobEve on 17-12-22 下午5:45
 * Copyright (c) 2017. All rights reserved.
 *
 * Last modified 17-12-22 下午1:43
 */
...
import bob.eve.pm.mvp.model.bean.tian.TianGirl;
...
public class HiGirlTianAdapter extends BaseQuickAdapter<TianGirl, BaseViewHolder> {
	private Fragment fragment;

	public HiGirlTianAdapter(Fragment fragment, @LayoutRes int layoutResId) {
		super(layoutResId);
	...
	@Override
	protected void convert(final BaseViewHolder helper, final TianGirl item) {
